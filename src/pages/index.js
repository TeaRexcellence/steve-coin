...
export default function Home() {
  return (
    <>
      ...
      <PrimaryContainer meta={<Meta metaTitle="The bird is the word" metaImg="/favicon.jpg" description="Steve is a community owned meme coin ready to take over the world!" />}>
